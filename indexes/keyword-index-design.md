...
- Keyword assignment: **in progress — indexed through `KQ-CCM-0375` (375 / 497)**
...
- Next keyword-index activity: **construct `KQ-CCM-0376`–`KQ-CCM-0400`, reusing or extending the working vocabulary only when the canonical text requires it**
