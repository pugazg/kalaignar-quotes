...
- [`opening-word-0351-0375.md`](opening-word-0351-0375.md) — continuation batch for `KQ-CCM-0351`–`KQ-CCM-0375`; overall opening-word coverage is now **375 / 497 quotes**

The next opening-word construction batch is `KQ-CCM-0376`–`KQ-CCM-0400`. Continuation batches are kept separate so the established consolidated master index is not rewritten or risked during incremental construction; final Tamil-collation consolidation can be performed after full coverage.
