...
- Keyword assignment: **in progress — indexed through `KQ-CCM-0125` (125 / 497)**
...
- Next keyword-index activity: **construct `KQ-CCM-0126`–`KQ-CCM-0150`, reusing or extending the working vocabulary only when the canonical text requires it**
