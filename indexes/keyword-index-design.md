...
- Keyword assignment: **in progress — indexed through `KQ-CCM-0400` (400 / 497)**
...
- Next keyword-index activity: **construct `KQ-CCM-0401`–`KQ-CCM-0425`, reusing or extending the working vocabulary only when the canonical text requires it**
