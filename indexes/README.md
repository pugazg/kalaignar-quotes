...
- [`keyword-index-design.md`](keyword-index-design.md) — keyword-index construction protocol and lifecycle record. Design version **0.1**; sequential assignment, full consistency review, vocabulary freeze and consolidated publication are complete for **497 / 497** quotes.
- [`keyword-vocabulary.md`](keyword-vocabulary.md) — frozen controlled keyword vocabulary version **1.0** with **182 stable keys**, based on the completed v0.9 consistency review. The recorded migration is `hindikkara-state` → `hindi-state`; `patience` is the consistency-added reusable key.
- [`keyword.md`](keyword.md) — complete consolidated keyword discovery index for `KQ-CCM-0001`–`KQ-CCM-0497` (**497 / 497 quotes**) under frozen vocabulary version **1.0**, incorporating all consistency corrections while preserving `KQ-CCM-0391` as `needs_review`.
- [`keyword-consistency-review.md`](keyword-consistency-review.md) — completed full consistency pass across all **497 / 497** keyword assignments. It records **21 quote-row corrections across 12 batch files**, the version 0.9 vocabulary decisions, and preservation of source verification states before the version 1.0 freeze.
...
- [`keyword-0076-0100.md`](keyword-0076-0100.md) — fourth keyword-index construction batch for `KQ-CCM-0076`–`KQ-CCM-0100`.
- [`keyword-0101-0125.md`](keyword-0101-0125.md) — fifth keyword-index construction batch for `KQ-CCM-0101`–`KQ-CCM-0125`.
- [`keyword-0126-0150.md`](keyword-0126-0150.md) — sixth keyword-index construction batch for `KQ-CCM-0126`–`KQ-CCM-0150`.
- [`keyword-0151-0175.md`](keyword-0151-0175.md) — seventh keyword-index construction batch for `KQ-CCM-0151`–`KQ-CCM-0175`.
- [`keyword-0176-0200.md`](keyword-0176-0200.md) — eighth keyword-index construction batch for `KQ-CCM-0176`–`KQ-CCM-0200`.
- [`keyword-0201-0225.md`](keyword-0201-0225.md) — ninth keyword-index construction batch for `KQ-CCM-0201`–`KQ-CCM-0225`.
- [`keyword-0226-0250.md`](keyword-0226-0250.md) — tenth keyword-index construction batch for `KQ-CCM-0226`–`KQ-CCM-0250`.
- [`keyword-0251-0275.md`](keyword-0251-0275.md) — eleventh keyword-index construction batch for `KQ-CCM-0251`–`KQ-CCM-0275`.
- [`keyword-0276-0300.md`](keyword-0276-0300.md) — twelfth keyword-index construction batch for `KQ-CCM-0276`–`KQ-CCM-0300`.
- [`keyword-0301-0325.md`](keyword-0301-0325.md) — thirteenth keyword-index construction batch for `KQ-CCM-0301`–`KQ-CCM-0325`.
- [`keyword-0326-0350.md`](keyword-0326-0350.md) — fourteenth keyword-index construction batch for `KQ-CCM-0326`–`KQ-CCM-0350`.
- [`keyword-0351-0375.md`](keyword-0351-0375.md) — fifteenth keyword-index construction batch for `KQ-CCM-0351`–`KQ-CCM-0375`.
- [`keyword-0376-0400.md`](keyword-0376-0400.md) — sixteenth keyword-index construction batch for `KQ-CCM-0376`–`KQ-CCM-0400`.
- [`keyword-0401-0425.md`](keyword-0401-0425.md) — seventeenth keyword-index construction batch for `KQ-CCM-0401`–`KQ-CCM-0425`.
- [`keyword-0426-0450.md`](keyword-0426-0450.md) — eighteenth keyword-index construction batch for `KQ-CCM-0426`–`KQ-CCM-0450`.
- [`keyword-0451-0475.md`](keyword-0451-0475.md) — nineteenth keyword-index construction batch for `KQ-CCM-0451`–`KQ-CCM-0475`.
- [`keyword-0476-0497.md`](keyword-0476-0497.md) — twentieth and final keyword-index construction batch for `KQ-CCM-0476`–`KQ-CCM-0497`.
...
- [`theme-0476-0497.md`](theme-0476-0497.md) — twentieth and final quote-level theme-classification batch for `KQ-CCM-0476`–`KQ-CCM-0497`.
...
The full theme consistency pass is complete. It confirmed **497 unique theme rows with no gaps or duplicates**, valid controlled keys, valid primary/secondary cardinality, and preservation of all verification states. The three `other-unclear` assignments (`KQ-CCM-0306`, `KQ-CCM-0343`, `KQ-CCM-0403`) were re-read and retained. The pass applied **13 assignment corrections across 10 batch files** to align general character, cause-oriented struggle and no-inference cases with taxonomy version 1.0; details are recorded in [`theme-consistency-review.md`](theme-consistency-review.md).

The consolidated theme index is published in [`theme.md`](theme.md). It contains all **497 / 497** assignments in quote-ID order, incorporates the completed consistency corrections, and continues to preserve `KQ-CCM-0391` as `needs_review`.

Sequential keyword-index construction, the required full consistency pass, the controlled-vocabulary freeze and consolidated publication are complete under design version **0.1**. The twenty batch files cover **497 / 497 quotes**. The consistency pass confirmed a contiguous set of **497 unique rows**, one to five valid keywords per quote, and preservation of the canonical verification states: **496 `verified_from_scan` and 1 `needs_review` (`KQ-CCM-0391`)**. It applied **21 quote-row corrections across 12 batch files**, added `patience`, and migrated the one-off `hindikkara-state` key into `hindi-state`. The resulting **182-key** vocabulary is frozen as version **1.0** in [`keyword-vocabulary.md`](keyword-vocabulary.md), and [`keyword.md`](keyword.md) publishes all **497 / 497** consistency-reviewed assignments. `KQ-CCM-0391` remains `needs_review`, its obscured terminal glyph remains unresolved, and no canonical quote file was modified. Future controlled-vocabulary changes require a version increment and explicit migration handling where existing assignments are affected.
