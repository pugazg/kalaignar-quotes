...
- Keyword assignment: **in progress — indexed through `KQ-CCM-0425` (425 / 497)**
...
- Next keyword-index activity: **construct `KQ-CCM-0426`–`KQ-CCM-0450`, reusing or extending the working vocabulary only when the canonical text requires it**
