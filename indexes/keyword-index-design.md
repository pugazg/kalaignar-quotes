...
- Keyword assignment: **in progress — indexed through `KQ-CCM-0300` (300 / 497)**
...
- Next keyword-index activity: **construct `KQ-CCM-0301`–`KQ-CCM-0325`, reusing or extending the working vocabulary only when the canonical text requires it**
