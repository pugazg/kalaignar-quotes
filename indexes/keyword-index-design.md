...
- Keyword assignment: **in progress — indexed through `KQ-CCM-0175` (175 / 497)**
...
- Next keyword-index activity: **construct `KQ-CCM-0176`–`KQ-CCM-0200`, reusing or extending the working vocabulary only when the canonical text requires it**
