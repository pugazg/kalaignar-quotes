...
- [`opening-word-0126-0150.md`](opening-word-0126-0150.md) — continuation batch for `KQ-CCM-0126`–`KQ-CCM-0150`; overall opening-word coverage is now **150 / 497 quotes**

The next opening-word construction batch is `KQ-CCM-0151`–`KQ-CCM-0175`. Continuation batches are kept separate so the established consolidated master index is not rewritten or risked during incremental construction; final Tamil-collation consolidation can be performed after full coverage.
