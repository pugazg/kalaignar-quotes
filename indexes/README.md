...
- [`keyword-index-design.md`](keyword-index-design.md) — keyword-index construction protocol, evidence rules, working-vocabulary lifecycle, 25-quote batching, validation and final consolidation plan. Design version **0.1**; sequential keyword assignment is complete for `KQ-CCM-0001`–`KQ-CCM-0497` (**497 / 497**), with the full consistency pass next.
- [`keyword-vocabulary.md`](keyword-vocabulary.md) — working keyword vocabulary version **0.8** with **182 stable keys**; the twentieth and final construction batch required no new keys, and the vocabulary remains working pending the full consistency pass.
...
Sequential keyword-index construction is complete under design version **0.1**. All twenty batches, from [`keyword-0001-0025.md`](keyword-0001-0025.md) through [`keyword-0476-0497.md`](keyword-0476-0497.md), cover **497 / 497 quotes**. [`keyword-vocabulary.md`](keyword-vocabulary.md) remains working version **0.8** with **182 keys**; the twentieth and final construction batch required no new stable keys. The indexed verification states are **496 `verified_from_scan` and 1 `needs_review` (`KQ-CCM-0391`)**. The `needs_review` status and unresolved terminal glyph of `KQ-CCM-0391` remain preserved, and canonical quote files were not modified. The next planned derived-discovery activity is the **full repository-wide keyword consistency pass across all 497 assignments**. Only after that pass should the vocabulary be frozen as version **1.0** and the consolidated `keyword.md` index be published.
