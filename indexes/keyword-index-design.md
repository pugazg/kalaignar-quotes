...
- Keyword assignment: **in progress — indexed through `KQ-CCM-0325` (325 / 497)**
- Construction cadence: **25 quotes per sequential batch**, with a shorter final batch when needed
- Vocabulary state: **working — [`keyword-vocabulary.md`](keyword-vocabulary.md), version 0.6 with 174 keys**
- Next keyword-index activity: **construct `KQ-CCM-0326`–`KQ-CCM-0350`, reusing or extending the working vocabulary only when the canonical text requires it**
