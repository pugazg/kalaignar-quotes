...
- [`keyword-index-design.md`](keyword-index-design.md) — keyword-index construction protocol, evidence rules, working-vocabulary lifecycle, 25-quote batching, validation and final consolidation plan. Design version **0.1**; keyword assignment is in progress through `KQ-CCM-0150` (**150 / 497**).
- [`keyword-vocabulary.md`](keyword-vocabulary.md) — working keyword vocabulary version **0.5** with **167 stable keys**; the sixth batch reused the existing vocabulary without adding keys, and the vocabulary remains open for evidence-driven extension during construction.
...
- [`keyword-0126-0150.md`](keyword-0126-0150.md) — sixth keyword-index construction batch for `KQ-CCM-0126`–`KQ-CCM-0150`; overall keyword coverage is **150 / 497 quotes**.
...
Keyword-index construction is in progress under design version **0.1**. The first six batches, [`keyword-0001-0025.md`](keyword-0001-0025.md), [`keyword-0026-0050.md`](keyword-0026-0050.md), [`keyword-0051-0075.md`](keyword-0051-0075.md), [`keyword-0076-0100.md`](keyword-0076-0100.md), [`keyword-0101-0125.md`](keyword-0101-0125.md) and [`keyword-0126-0150.md`](keyword-0126-0150.md), cover **150 / 497 quotes**. [`keyword-vocabulary.md`](keyword-vocabulary.md) remains working version **0.5** with **167 keys** because this batch required no new stable vocabulary entries. All 150 indexed source verification states remain `verified_from_scan`, and canonical quote files were not modified. The next planned derived-discovery activity is the **seventh keyword construction batch, `KQ-CCM-0151`–`KQ-CCM-0175`**, reusing or extending the working vocabulary only when directly supported by canonical text.
