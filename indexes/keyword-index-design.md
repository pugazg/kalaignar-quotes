...
- Keyword assignment: **in progress — indexed through `KQ-CCM-0450` (450 / 497)**
...
- Next keyword-index activity: **construct `KQ-CCM-0451`–`KQ-CCM-0475`, reusing or extending the working vocabulary only when the canonical text requires it**
