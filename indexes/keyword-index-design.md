...
- Keyword assignment: **in progress — indexed through `KQ-CCM-0150` (150 / 497)**
...
- Next keyword-index activity: **construct `KQ-CCM-0151`–`KQ-CCM-0175`, reusing or extending the working vocabulary only when the canonical text requires it**
