...
- [`opening-word-0151-0175.md`](opening-word-0151-0175.md) — continuation batch for `KQ-CCM-0151`–`KQ-CCM-0175`; overall opening-word coverage is now **175 / 497 quotes**

The next opening-word construction batch is `KQ-CCM-0176`–`KQ-CCM-0200`. Continuation batches are kept separate so the established consolidated master index is not rewritten or risked during incremental construction; final Tamil-collation consolidation can be performed after full coverage.
