...
- Keyword assignment: **in progress — indexed through `KQ-CCM-0200` (200 / 497)**
...
- Next keyword-index activity: **construct `KQ-CCM-0201`–`KQ-CCM-0225`, reusing or extending the working vocabulary only when the canonical text requires it**
