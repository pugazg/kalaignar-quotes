...
- [`theme-taxonomy.md`](theme-taxonomy.md) — controlled theme vocabulary and assignment rules for the derived theme index. Taxonomy version **1.0** defines 16 stable theme keys; quote-level theme assignment has not yet started.
...
The next derived discovery activity is a first theme-classification batch using [`theme-taxonomy.md`](theme-taxonomy.md). Classification must be based on canonical quote text, assign exactly one primary theme and at most two secondary themes, and preserve canonical verification states without editing source transcriptions.
