...
- [`keyword-index-design.md`](keyword-index-design.md) — keyword-index construction protocol, evidence rules, working-vocabulary lifecycle, 25-quote batching, validation and final consolidation plan. Design version **0.1**; keyword assignment is in progress through `KQ-CCM-0125` (**125 / 497**).
- [`keyword-vocabulary.md`](keyword-vocabulary.md) — working keyword vocabulary version **0.5**, extended through the first 125 canonical quotes with **167 stable keys**; vocabulary remains open for evidence-driven extension during construction.
...
- [`keyword-0101-0125.md`](keyword-0101-0125.md) — fifth keyword-index construction batch for `KQ-CCM-0101`–`KQ-CCM-0125`; overall keyword coverage is **125 / 497 quotes**.
...
Keyword-index construction is in progress under design version **0.1**. The first five batches, [`keyword-0001-0025.md`](keyword-0001-0025.md), [`keyword-0026-0050.md`](keyword-0026-0050.md), [`keyword-0051-0075.md`](keyword-0051-0075.md), [`keyword-0076-0100.md`](keyword-0076-0100.md) and [`keyword-0101-0125.md`](keyword-0101-0125.md), cover **125 / 497 quotes**. [`keyword-vocabulary.md`](keyword-vocabulary.md) is now working version **0.5** with **167 keys**. All 125 indexed source verification states remain `verified_from_scan`, and canonical quote files were not modified. The next planned derived-discovery activity is the **sixth keyword construction batch, `KQ-CCM-0126`–`KQ-CCM-0150`**, reusing or extending the working vocabulary only when directly supported by canonical text.
