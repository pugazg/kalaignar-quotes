...
- English first-pass coverage: **200 / 497**
- Completed batches:
...
- Source states represented so far: **200 `verified_from_scan`**
- Pilot fidelity/style review: [`PILOT_REVIEW.md`](PILOT_REVIEW.md) — **complete**
- Glossary: [`GLOSSARY.md`](GLOSSARY.md), version **1.3** — pilot conventions locked; Batch-2 through Batch-4 terminology added; Batches 5–8 required no glossary revision
