...
- [`opening-word-0376-0400.md`](opening-word-0376-0400.md) — continuation batch for `KQ-CCM-0376`–`KQ-CCM-0400`; overall opening-word coverage is now **400 / 497 quotes**. This batch preserves `KQ-CCM-0391` as `needs_review` and does not promote its unresolved source reading.

The next opening-word construction batch is `KQ-CCM-0401`–`KQ-CCM-0425`. Continuation batches are kept separate so the established consolidated master index is not rewritten or risked during incremental construction; final Tamil-collation consolidation can be performed after full coverage.
